...
jokes <-
  lapply(1:100, function(i)
    readLines(paste("jokes/init", i, ".html", sep = "")))

# get rid of first 5 lines (title)
jokes <- lapply(jokes, "[",-c(1:5))

filter_tags <- function(txt)
  gsub("<[^>]*>", "", txt)
filter_nbsp <- function(txt)
  gsub("&nbsp;", "", txt)
...
save(Jester, JesterJokes, file = "../../data/Jester.rda")
...
save(Jester5k, JesterJokes, file = "../../data/Jester5k.rda")
